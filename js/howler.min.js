...
!(function () {
  ...
  e.prototype = {
    ...
    volume: function (e) {
      var t = this || n;
      if (
        ((e = parseFloat(e)), t.ctx || _(), void 0 !== e && e >= 0 && e <= 1)
      ) {
    ...
    _enableMobileAudio: function () {
      var e = this || n,
        t = /iPhone|iPad|iPod|Android|BlackBerry|BB10|Silk|Mobi/i.test(
  ...
  t.prototype = {
    ...
    play: function (e, t) {
      ...
      if (o._webAudio) {
        ...
        'running' === n.state
          ? f()
          : (o.once('resume', f), o._clearTimer(i._id));
      } else {
        var p = function () {
            (c.currentTime = _),
            ...
            try {
              ...
              '__default' !== e || i._loop
                ...
                : ((o._endTimers[i._id] = function () {
                    o._ended(i),
                      c.removeEventListener('ended', o._endTimers[i._id], !1);
                  }),
    ...
    volume: function () {
      ...
      if (1 === r.length || (2 === r.length && void 0 === r[1])) {
        o._getSoundIds().indexOf(r[0]) >= 0
          ? (t = parseInt(r[0], 10))
          : (e = parseFloat(r[0]));
      } else
        r.length >= 2 && ((e = parseFloat(r[0])), (t = parseInt(r[1], 10)));
      var a;
      if (!(void 0 !== e && e >= 0 && e <= 1))
        return (a = t ? o._soundById(t) : o._sounds[0]), a ? a._volume : 0;
      if ('loaded' !== o._state)
        return (
          o._queue.push({
            event: 'volume',
    ...
    rate: function () {
      ...
      var i;
      if ('number' != typeof e)
        return (i = o._soundById(t)), i ? i._rate : o._rate;
      if ('loaded' !== o._state)
        return (
          o._queue.push({
            event: 'rate',
      ...
      for (var d = 0; d < t.length; d++)
        if ((i = o._soundById(t[d]))) {
          ...
          (!o._endTimers[t[d]] && i._paused) ||
            (o._clearTimer(t[d]),
            (o._endTimers[t[d]] = setTimeout(o._ended.bind(o, i), l))),
            o._emit('rate', i._id);
        }
      return o;
    },
    seek: function () {
      ...
      if (0 === r.length) t = o._sounds[0]._id;
        ...
        u >= 0
          ? (t = parseInt(r[0], 10))
          : o._sounds.length &&
            ((t = o._sounds[0]._id), (e = parseFloat(r[0])));
      } else
        2 === r.length && ((e = parseFloat(r[0])), (t = parseInt(r[1], 10)));
