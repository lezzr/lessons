...
const dateStringDayPlusOne = new Intl.DateTimeFormat()
    ...
    .join('-');
function renderSort() {
    renderBlock2('sort-results-block', `
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    renderUserBlock(userData === null || userData === void 0 ? void 0 : userData.userAvatar, userData === null || userData === void 0 ? void 0 : userData.userName, favouritesData);
